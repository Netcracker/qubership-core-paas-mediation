...
require (
	...
	github.com/netcracker/qubership-core-lib-go-paas-mediation-client/v8 v8.8.6
...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.6.6 // indirect
