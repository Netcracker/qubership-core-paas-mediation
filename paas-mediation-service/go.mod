...
require (
	...
	github.com/netcracker/qubership-core-lib-go-paas-mediation-client/v8 v8.5.3
...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.5.3 // indirect
