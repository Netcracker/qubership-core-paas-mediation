...
//
//	mockgen -source=wsController.go -destination=wsController_mock.go -package=v2
//
...
func (mr *MockWsConnMockRecorder) SetCloseHandler(h any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWsConnMockRecorder) WriteControl(msgType, data, deadline any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWsConnMockRecorder) WriteMessage(msgType, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
